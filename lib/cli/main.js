...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bcscore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bcscore-node add wallet-service');
      console.log('    $ bcscore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bcscore-node remove wallet-service');
      console.log('    $ bcscore-node remove insight-api');
      console.log();
    });
